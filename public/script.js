...
// KORVAA KOKO VANHA handleFormSubmit TÄLLÄ UUDELLA, PARANNELLULLA VERSIOLLA
async function handleFormSubmit(e) {
    ...
    try {
        ...
        buttonText.textContent = 'Lähetä varauspyyntö'; // Palautetaan alkuperäinen teksti
        submitButton.disabled = false;
    }
}
...
// KORVAA VANHA closeModal-FUNKTIO TÄLLÄ
function closeModal() {
